...
import 'package:hackathon/Features/Maintenance/Breakdowns/breakdowns.dart';
...
import 'SOP/SOP.dart';
import 'SparePartsManagement/spare.dart';
        ...
        body: ListView(
              children: [ Column(
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Spare()));
                    },
                      child: FeaturesCard(svgAsset: "$path/services-icon.svg", title: "Spare Parts")),
                  GestureDetector(
                    onTap: (){
                  ...
                  GestureDetector(
                    onTap:(){
                      ...
                      child: FeaturesCard(svgAsset: "$path/target-line-icon.svg", title: "SOPs"))
                ],
              ),]
