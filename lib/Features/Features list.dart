...
import 'package:hackathon/Features/SparePartsManagement/spare.dart';
import 'package:hackathon/Widgets/Features_Card.dart';

import '../Widgets/BottomNavBar.dart';
import 'Maintenance/Breakdowns/breakdowns.dart';
import 'SOP/SOP.dart';
        ...
        body: ListView(
              children: [ Column(
                children: [
                  ...
                  GestureDetector(
                    onTap: (){                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Spare()));
                    },
                      child: FeaturesCard(svgAsset: "$path/services-icon.svg", title: "Spare Parts Management")),
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Breakdowns()));

                    },
                      child: FeaturesCard(svgAsset: "$path/workshop-icon.svg", title: "Maintenance")),
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>CardCarousel()));

                    },
                      child: FeaturesCard(svgAsset: "$path/target-line-icon.svg", title: "Ideal/SOPs"))
                ],
              ),]
