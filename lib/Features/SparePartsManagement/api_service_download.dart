...
class ApiServicedownload3 {
  static const String fileUrl = 'http://${Strings.localhost}/sparepartsapi/downloadsparepart';
  ...
  static Future<String?> getFilePath() async {
    try {
      Directory? storageDir = await getApplicationDocumentsDirectory();
      String filePath = '${storageDir?.path}/spareparts.pdf';
      return filePath;
    } catch (e) {
